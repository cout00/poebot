...
namespace PoeItemObjectModelLib {
    ...
    public class ItemFactory {
        ...
        public static IItemBaseHeader GetModel(string str) {
            try {
    ...
    class ItemHeader :IItemBaseHeader {
        public string BaseName { get; set; }
        public string Class { get; set; }
        public ItemStatus ItemStatus { get; set; }
        public ItemRarity Rarity { get; set; }

        protected TItem Selector<TItem>() where TItem : IItemBaseHeader {
            
        }

        protected virtual void Parse(string rawdata) {
            
        }

        void IItem.Parse(string rawData) {
            Parse(rawData);
        }
    }
    ...
    interface IImplicitModifiers {
        
    }

    interface IExplicitModifiers {
